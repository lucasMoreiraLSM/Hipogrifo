...
<body>
    ...
    <div class="container centralizar">
        <div class="row justify-content-center">
            <div id="card-logo" class="col-md-6   text-light">
                <div class="bg-azul text-center  p-4 rounded-start">
                    ...
                    <a id="botao-sinza" href="login.php" style="margin-top: 33px;"
      ...
      if(@$_POST['nome']){
		...
		$dadosAdd = $conex->prepare('INSERT INTO usuario (cpf, nome, email, senha, tipo, status) VALUES (?, ?, ?,  ?, ?, ? )');
		...
		$dadosAdd  ->bindValue(6, $status, PDO::PARAM_STR);
...
?>
                    ...
                    <form class="row g-3 needs-validation" novalidate method="post">
                        ...
                        <div class="col-12 text-center">
                            <div>
                                <button id="botao-azul" style="margin-top:0px" class="btn btn-primary bnt-lg"
