...
<html lang="pt-BR">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-3   text-light"> 
               ...
               <img src="img/hipogrifo_logo.svg" width="100%" alt="logo" />
          <p class="text-center mt-4">    Olá <? echo $nome_usuario ?> </p>
  ...
  <a href="index.php?pag=disciplina" class="list-group-item list-group-item-action">Disciplina</a> 
  <a href="index.php?pag=usuarios" class="list-group-item list-group-item-action">Usuários</a> 
  <a href="index.php?doLogout=true" class="list-group-item list-group-item-action"><i class="fas fa-sign-out-alt"></i> Sair</a> 
</div>
